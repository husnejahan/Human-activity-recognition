...
lr =1e-6 # Learning rate have changed from -3

dataset = 'hmdb51_dataset' # Options: hmdb51 or ucf101

if dataset == 'hmdb51_dataset':
    num_classes=4
else:
    print('We only implemented kth hmdb and ucf datasets.')
...
def train_model(dataset=dataset, save_dir=save_dir, num_classes=num_classes, lr=lr,
    ...
    optimizer = optim.Adam(train_params, lr=lr,betas=(0.9,0.999), weight_decay=5e-4)# changed for Adam
...
if __name__ == "__main__":
    train_model()
    print("training completed using Adam optimizer,lr=1e-6,batch size=10")
